...
export class MandatoryTrainingsDto {
    @IsBoolean()
    @IsNotEmpty()
    ...
    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'dementiaAwarenessTrainedAt'})
    dementiaAwarenessTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'privacyAndDignityTrainedAt'})
    privacyAndDignityTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'communicationTrainedAt'})
    communicationTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'dutyOfCareTrainedAt'})
    dutyOfCareTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'foodHygieneTrainedAt'})
    foodHygieneTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'safeguardingAdultsTrainedAt'})
    safeguardingAdultsTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'safeguardingChildrenTrainedAt'})
    safeguardingChildrenTrainedAt: Date;

    @IsString()
    @IsOptional()
    @ApiProperty({type: Date, description: 'fireSafetyTrainedAt'})
